        ...
        <section class="bg-light py-5 position-relative overflow-hidden">
            ...
            <div class="container position-relative">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6">
                        <!-- Title -->
                        <h3>ثبت نام در دوره "{{ $course->title }}"</h3>
                        <!-- Button -->
                    </div>
                ...
                <div class="row">
                    ...
                    >
                        ...
                        <div class="card card-body shadow p-4">
                            <!-- Title -->
                            <h3>جهت ثبت نام فرم زیر را پر کنین</h3>
                            <!-- Form START -->
                            <form class="row g-3 mt-2 position-relative z-index-9" method="post" action="{{ route('course-registers.store') }}">
                                @csrf
                                <!-- Name -->
                                <div class="col-lg-12">
...
{{--                                </div>--}}
                    ...
                    <div class="col-lg-7 z-index-9 mt-5 mt-xl-0">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            >
                                <p>
                                    لطفا جهت ثبت نام در دوره مشخصات خود را وارد کنید تا کارشناسان برای هماهنگی بیشتر با شما تماس بگیرند.
                                </p>
                            </div>
                        </div>
                        <!-- Tab contents END -->
