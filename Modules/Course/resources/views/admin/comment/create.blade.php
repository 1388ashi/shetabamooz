...
@section('content')
    ...
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ثبت فرم جدید</li>
        </ol>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control mb-4" placeholder="لطفا نام کاربر را وارد کنید" name="name" type="text" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="email"  class="control-label">ایمیل</label>
                                                                    <input class="form-control mb-4" placeholder="لطفا ایمیل کاربر را وارد کنید" name="email" type="text">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="text-danger">&starf;</span>
                                                                    <input class="form-control mb-4" placeholder="لطفا شماره تلفن همراه کاربر را وارد کنید" name="mobile" type="text" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="text-danger">&starf;</span>
                                                                    <input class="form-control mb-4" placeholder="لطفا سن کاربر را وارد کنید" name="age" type="number" required>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span class="text-danger">&starf;</span>
                                                                    <textarea class="form-control" placeholder="لطفا متن خود را وارد کنید" name="text" rows="3"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
