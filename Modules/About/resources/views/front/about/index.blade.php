            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    <div class="col-10 text-center mx-auto position-relative">
                        ...
                        <!-- SVG decoration -->
                        <figure
                            class="position-absolute top-100 start-100 translate-middle ms-5 d-none d-md-block"
                        >
                        ...
                        <h1 class="position-relative fs-2">
                            {{ \Modules\Setting\App\Models\Setting::getFromName('about_title_1') }}
                        </h1>
                    </div>
                    <!-- Title and SVG END -->
                </div>
                ...
                <div class="row g-4 mt-0 mt-lg-5">
                    ...
                    <div class="col-6 col-md-4">
                        <div class="row g-4">
                            ...
                            <div class="col-10 col-lg-6">
                                <img
                                    class="rounded-4"
                                    src="{{ asset('front/assets/images/about/05.jpg') }}"
                                    alt=""
                                />
                            </div>
                            <!-- Image -->
                            <div class="col-12">
                                <img
                                    class="rounded-4"
                                    src="{{ asset('front/assets/images/about/03.jpg') }}"
                                    alt=""
                                />
                            </div>
                        </div>
                    ...
                    <div class="col-6 col-md-4 position-relative">
                        ...
                        <!-- Image -->
                        <img class="rounded-4" src="{{ asset('front/assets/images/about/09.jpg') }}" alt="" />
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6 col-md-12 col-lg-6">
                                <img
                                    class="rounded-4"
                                    src="{{ asset('front/assets/images/about/10.jpg') }}"
                                    alt=""
                                />
                            </div>
                        </div>
  ...
  About founder START -->
        <section class="pt-0 pt-md-5">
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-lg-8">
                        <h2>درباره شتاب آموز</h2>
                        <p class="mb-0">
                             {{ \Modules\Setting\App\Models\Setting::getFromName('about_subtitle') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 position-relative">
                        <!-- SVG decoration -->
                        <figure
                            class="position-absolute top-0 start-0 d-inline-block mt-n3"
                        ></figure>

                        <!-- Image -->
                        <img src="{{ asset('front/assets/images/about/06.jpg') }}" class="rounded" alt="" />
                    </div>

                    <div class="col-lg-7 mt-4 mt-lg-0">
                        <!-- Title -->
                        <h4 class="mb-3">
                            {{ \Modules\Setting\App\Models\Setting::getFromName('about_title_2') }}
                        </h4>

                        <!-- Content -->
                        <p>
                            {{ \Modules\Setting\App\Models\Setting::getFromName('about_description') }}
                        </p>

                        <!-- Info -->
                        <ul class="list-group list-group-borderless mt-4">
                            <li class="list-group-item d-flex">
                                <i class="bi bi-patch-check-fill text-success me-2"></i>آموزش
                                برنامه نویسی در گرگان
                            </li>
                            <li class="list-group-item d-flex">
                            ...
                            <li class="list-group-item d-flex">
                                <i class="bi bi-patch-check-fill text-success me-2"></i>بازار
                                کار برای برنامه نویسی
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-sm-flex justify-content-sm-between">
                            <h2 class="mb-0">اساتید شتاب آموز</h2>
                            <a href="{{ route('cooperation-requests.index') }}" class="btn btn-light mt-2">همکاری با شتاب آموز</a>
                        </div>

                        <!-- Slider START -->
                        <div
                            class="tiny-slider arrow-round arrow-creative arrow-blur arrow-hover mt-2 mt-sm-5"
                        >
                            <div
                            ...
                            >
                                ...
                                @foreach($professors as $professor)
                                    ...
                                    <div class="text-center">
                                        ...
                                        <!-- Info -->
                                        <h6 class="mb-0"><a href="#">{{ $professor->name }}</a></h6>
                                        <p class="mb-0 small">{{ $professor->role }}</p>
                                        <!-- Rating -->
                                    </div>
                                @endforeach
