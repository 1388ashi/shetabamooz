                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.post-categories.store') }}" method="post" enctype="multipart/form-data" class="save">
                                    @csrf
                                    <div class="row">
                                        <div class="col">
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <!--search-->
                    <form method="get" id='basicSearch' action="{{route('admin.post-categories.index')}}"
                          autocomplete="off"
...
{{--                                    <td><img src="{{ $category->image }}" alt="category-image" class="img-fluid"></td>--}}
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route('admin.post-categories.destroy',$category->id)}}" method="post" id="delete-{{ $category->id }}" style="display: none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
                    ...
                    <div class="modal fade" id="editCategory" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('admin.post-categories.modalUpdate') }}" method="post" class="save" enctype="multipart/form-data">
                                        @csrf
                                        @method('PATCH')
                                        <div class="row">
                                            <div class="col">
...
@section('scripts')
    ...
    @include('core::includes.delete-all-script', [$model_name = 'post-categories'])
