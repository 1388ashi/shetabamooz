...
@section('contact')
            ...
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-sm-10 col-xl-6 text-center mx-auto">
                        <h2>قطعا ما برای رشد بیشتر به شما نیاز داریم</h2>
                        <p class="mb-0">
                            آموزشگاه عصرنخبگان در تاریخ 1392/11/12 با اخذ مجوز از سازمان
                            آموزش فنی و حرفه ای شهر تهران در رشته فناوری اطلاعات شروع به
                            فعالیت نموده و علیرغم وجود مشکلات و چالشهای پیش‌رو، در مدت زمان
                ...
                <div class="row g-4 g-md-5">
                    ...
                    <div class="col-md-4 text-center">
                        <img
                            src="assets/images/element/create-account.svg"
                            class="h-200px"
                            alt=""
                        />
                        <h4 class="mt-3">اکانت مجزا</h4>
                    ...
                    <div class="col-md-4 text-center">
                        <img
                            src="assets/images/element/add-course.svg"
                            class="h-200px"
                            alt=""
                        />
                        <h4 class="mt-3">بروز بودن</h4>
                        <p class="text-truncate-2 mb-0">
                            آموزشگاه عصرنخبگان در تاریخ 1392/11/12 با اخذ مجوز از سازمان
                            آموزش فنی و حرفه ای شهر تهران در رشته فناوری اطلاعات شروع به
                            فعالیت نموده و علیرغم وجود مشکلات و چالشهای پیش‌رو، در مدت زمان
                    ...
                    <div class="col-md-4 text-center">
                        <img
                            src="assets/images/element/earn-money.svg"
                            class="h-200px"
                            alt=""
                        />
                        <h4 class="mt-3">هر چیزی که دوست داری</h4>
                        <p class="text-truncate-2 mb-0">
                            آموزشگاه عصرنخبگان در تاریخ 1392/11/12 با اخذ مجوز از سازمان
                            آموزش فنی و حرفه ای شهر تهران در رشته فناوری اطلاعات شروع به
                            فعالیت نموده و علیرغم وجود مشکلات و چالشهای پیش‌رو، در مدت زمان
  ...
  Counter START -->
        <section class="py-0 py-lg-5">
            <div class="container">
                <div
                    class="bg-orange bg-opacity-10 p-4 p-sm-5 rounded position-relative overflow-hidden"
                >
                    <!-- SVG decoration -->
                    <figure
                    ...
                    >
                        <svg
                            class="fill-white opacity-8 rotate-193"
                            width="676px"
                            height="161.3px"
                ...
                />
                    ...
                    <!-- SVG decoration -->
                    <figure
                        class="position-absolute top-0 start-0 mt-3 ms-n3 opacity-5"
                    >
                    ...
                    <div
                        class="row g-4 position-relative align-items-center justify-content-center"
                    >
                        <!-- Counter item -->
                        <div class="col-sm-6 col-lg-3 text-center">
                            <div class="d-flex justify-content-center">
                                <h4
                                    class="purecounter display-6 text-orange fw-bold mb-0"
                            ...
                            <h6 class="mb-0 fw-bold">هنرجو</h6>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-3 text-center">
                            ...
                            <h6 class="mb-0 fw-bold">اساتید</h6>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-3 text-center">
                            ...
                            <h6 class="mb-0 fw-bold">دوره های برگزاری شده</h6>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-3 text-center">
                            ...
                            <h6 class="mb-0 fw-bold">زبان ها</h6>
                        </div>
                    </div>
                    <!-- Row END -->
                </div>
