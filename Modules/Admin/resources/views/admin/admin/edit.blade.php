    ...
    <div class="row">
        <div class="col-lg-12" >
            <div class="bg-white widget-user mb-5">
                <div class="card-body">
                    <div class="border-0">
                        <form action="{{ route('admin.admins.update', [$admin->id]) }}" method="post" class="save"
                              id="articleForm">
                            @csrf
                            @method('PUT')
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <label class="custom-control custom-checkbox">
                                                                        <input type="checkbox" class="custom-control-input" name="status" value="1"{{ $admin->status ? ' checked' : '' }}>
                                                                    ...
                                                                    @foreach($permissions->chunk(4) as $chunk)
                                                                        <div class="row">
                                                                            @foreach($chunk as $permission)
                                                                                <div class="col-3">
                                                                                    <label class="custom-control custom-checkbox">
                                                                                        <input type="checkbox" class="custom-control-input" name="permissions[]" value="{{ $permission->name }}"{{ $admin->permissions->pluck('name')->contains($permission->name) ? ' checked' : '' }}>
