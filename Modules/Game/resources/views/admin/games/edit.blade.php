...
@section('content')
    ...
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ویرایش مسابقه</li>
        </ol>
    </div>
    <!--  Page-header closed -->

    @include('components.errors')
    <form action="{{ route('admin.games.update', [$game->id]) }}" method="post" class="save"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">&starf;</span>
                                        <input type="text" name="subtitle" value="{{ old('subtitle',$game->subtitle) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">&starf;</span>
                                        <input type="text" name="prerequisite" value="{{ old('prerequisite',$game->prerequisite) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input name="published_at" id="from_published_at_hide" type="hidden"
                                            value="{{ old('published_at', $game->published_at) }}" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">&starf;</span>
                                        <input type="text" name="eventplace" value="{{ old('eventplace',$game->eventplace) }}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">&starf;</span>
                                        <textarea class="form-control" id="summary" placeholder="لطفا متن خود را وارد کنید" name="summary" required>{{ old('summary',$game->summary) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="catering" class="control-label">پذیرایی</label>
                                        <input type="text" name="catering" value="{{ old('catering',$game->catering) }}"
                                    ...
                                    <div
                                        ...
                                        <label for="description" class="control-label">توضیحات</label> <span class="text-danger">&starf;</span>
                                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                                ...
                                                <textarea class="ckeditor form-control" id="ckEditor" name="description">{!! old('description',$game->description) !!}</textarea>
                                            </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="fromhours" value="{{ old('fromhours',$game->fromhours) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="label" class="control-label">لینک ویدیو</label>
                                        <input class="form-control" type="text" name="video_link" placeholder="لینک ویدیو را وارد کنید" value="{{ old('video_link',$game->video_link) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="custom-control custom-checkbox">
                                          <input
                                            ...
                                            id="status"
                                            value="1"
                                            {{ old('status', $game->status) == 1 ? 'checked' : null }}
                                          />
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="image_alt" value="{{ old('image_alt',$game->image_alt) }}"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  name="meta_title"
                                                  rows="2">{{ old('meta_title',$game->meta_title) }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  rows="3">{{ old('meta_description',$game->meta_description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="canonical_tag" value="{{ old('canonical_tag',$game->canonical_tag) }}" placeholder="در صورت نیاز تگ canonicalرا وارد کنید">
                                    </div>
                                </div>
                                <div class="col">
