    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <form action="{{ route('admin.game-gifts.update',$gameGift->id) }}" method="post" class="save" enctype="multipart/form-data"
                        id="articleForm">
                        @csrf
                        @method('PATCH')
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="{{ old('title',$gameGift->title) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">&starf;</span>
                                        <input type="text" name="gift" value="{{ old('gift',$gameGift->gift) }}"
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    <div class="text-center">
                                        ...
                                        <a class="btn btn-outline-light" href="{{ route('admin.games.index') }}">برگشت</a>
                                    </div>
                                </div>
                            </div>
                        </div>
